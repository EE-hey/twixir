defmodule Twixir.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :twixs, Twixir.Twix
    has_many :subscriptions, Twixir.Subscription
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, Twixir.Repo)
  ...
  """
  def valid_password?(%Twixir.Accounts.User{hashed_password: hashed_password}, password)
